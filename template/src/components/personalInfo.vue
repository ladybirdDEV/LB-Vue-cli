  ...
  <div class="right-personinfo" :id="id">
    ...
    <div class="row text-left">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <label class="text-left">{{normalLanPack.email[lanIndex]}}</label>
        <input type="" name="" class="form-control" v-model="userInfo['email']">
      </div>
    </div>
    <div class="row text-left">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <label class="text-left">{{normalLanPack.address[lanIndex]}}</label>
        <input type="" name="" class="form-control" v-model="userInfo['address']">
      </div>
    </div>
    <div class="row text-left">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
    ...
    <button class="btn btn-primary col-lg-12 col-md-12 col-sm-12 col-xs-12" @click="editSave">{{normalLanPack.saveChange[lanIndex]}}</button>
  </div>
  <!-- /个人信息侧边栏 -->
</template>
<script>
