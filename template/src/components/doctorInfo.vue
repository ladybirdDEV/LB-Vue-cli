...
<div class="right-personinfo" :id="id">
  ...
  <button class="btn btn-primary col-lg-12 col-md-12 col-sm-12 col-xs-12" @click="editDoctorInfo">保存修改</button>
</div>
<!-- /个人信息侧边栏 -->
</template>
<script>
